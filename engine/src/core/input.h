...
//keyboard input
LAPI b8 input_is_key_down(keys key);
LAPI b8 input_is_key_up(keys key);
LAPI b8 input_was_key_down(keys key);
LAPI b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

// mouse input 
LAPI b8 input_is_button_down(buttons button);
LAPI b8 input_is_button_up(buttons button);
LAPI b8 input_was_button_down(buttons button);
LAPI b8 input_was_button_up(buttons button);
LAPI void input_get_mouse_position(i32* x, i32* y);
LAPI void input_get_previous_mouse_position(i32* x, i32* y);
